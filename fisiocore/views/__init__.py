...
from .medical_image import add_images, edit_medical_image, delete_medical_image, view_medical_image, medical_image, imagelist
from .medical_document import document, view_document, edit_document, add_document, delete_document, document_list
...
from .consent_document import view_consent_documents, view_consent_document, edit_consent_document, delete_consent_document, print_consent_document, add_consent_document, add_consent, view_consents, view_consent, revoke_consent
