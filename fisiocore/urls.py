...
urlpatterns = [
    ...
    path('patient/viewconsent/<int:patient_id>', views.view_consent, name='view_consent'),
    path('patient/viewconsent/<int:patient_id>/<int:consent_id>', views.view_consent, name='view_consent'),
    path('patient/addconsent/<int:patient_id>/<int:consent_template_id>', views.add_consent, name='add_consent'),
