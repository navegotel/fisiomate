...
from .models import Patient, UserProfile, TreatmentPlan, Session, Examination, MedicalImage, ClinicalDocument, InformedConsentDocument, InformedConsent, ExplorationTemplate
